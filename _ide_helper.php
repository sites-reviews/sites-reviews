 ...
 * Generated for Laravel 7.19.0 on 2020-07-23 15:08:55.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Mail {
        ...
        {
            //Method inherited from \Illuminate\Mail\MailManager            
                        /** @var \Vitalybaev\LaravelDkim\MailManager $instance */
         ...
         * @param string $driver
         * @param \Closure $callback
         * @return \Vitalybaev\LaravelDkim\MailManager 
         * @static 
         */ 
        public static function extend($driver, $callback)
        {
...
namespace shweshi\OpenGraph\Facades { 
    ...
    class OpenGraphFacade {
         ...
         * @static 
         */ 
        public static function fetch($url, $allMeta = null, $lang = null)
        {
                        /** @var \shweshi\OpenGraph\OpenGraph $instance */
                        return $instance->fetch($url, $allMeta, $lang);
        }
