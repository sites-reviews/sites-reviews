<div class="review" id="{{ $review->getAnchorName() }}">
    <div class="card mb-2" itemprop="review" itemscope itemtype="http://schema.org/UserReview">
        ...
        <div class="card-footer py-2 px-3 buttons">
            <div class="d-flex flex-row align-items-center">
                ...
                <div class="px-1 small rating" style="@if ($review->rating == 0) display:none; @endif">
                    {{ $review->rating }}
                </div>
                ...
                <a href="{{ route('reviews.publish', $review) }}" class="publish btn btn-light btn-sm"
                   style="@cannot('publish', $review) display:none; @endcannot">
                    {{ __('Publish') }}
                </a>
